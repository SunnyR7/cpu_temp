...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1 -new_name cpuclk -ip [get_ips cpuclk]]
...
if { [catch {
  file copy -force D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1/cpuclk.dcp D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1/cpuclk_stub.v D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1/cpuclk_stub.vhdl D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1/cpuclk_sim_netlist.v D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/VivadoProCS202/CPU/CPU.runs/cpuclk_synth_1/cpuclk_sim_netlist.vhdl D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/VivadoProCS202/CPU/CPU.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.v D:/VivadoProCS202/CPU/CPU.ip_user_files/ip/cpuclk
  }
}

if {[file isdir D:/VivadoProCS202/CPU/CPU.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force D:/VivadoProCS202/CPU/CPU.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl D:/VivadoProCS202/CPU/CPU.ip_user_files/ip/cpuclk
  }
}
